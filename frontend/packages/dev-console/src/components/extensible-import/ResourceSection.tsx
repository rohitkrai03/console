...
import { Resources, ReadableResourcesNames } from '../import/import-types';
import FormSection from '../import/section/FormSection';
import './ResourceSection.scss';
// import { useExtensions } from '@console/plugin-sdk';
// import { isImportResourceType } from '../../extensions/import-forms';
...
const ResourceSection: React.FC<ResourceSectionProps> = ({ flags }) => {
  const [field] = useField<Resources[]>('resource.blacklist');
  const invalidTypes = field.value || [];

  // const resourceTypeExtensions = useExtensions(isImportResourceType);
